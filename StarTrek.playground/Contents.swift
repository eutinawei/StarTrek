...
print(humanOfficersCount)



// Q1: What percentage of humans are female?
var femaleHumanCount = femaleOfficers.filter(humanOfficers.contains).count
var humanCount = humanOfficers.count
print(String(femaleHumanCount * 100 / humanCount) + "%")



// Q2: How many first officers are human?
var firstOfficerHuman = firstOfficers.keys.filter(humanOfficers.contains).count
print(firstOfficerHuman)



// Q3: Get a list of females sorted by name
var sortedFemale = femaleOfficers.sorted()
print(sortedFemale)
...
var allCaptains = captains.map{Officer(name: $0, ship: $1)}
...
var firstVulcans = firstOfficers.keys.filter(vulcanOfficers.contains)
print(firstVulcans)
...
var shorterNames = firstVulcans.reduce(0) {$1.count < 5 ? $0 + 1 : $0}
print(shorterNames)
